...
use rustic_rover3::common::type_define::{DoubleController, GameController, ProcessInfo, LogType};
use gamepads::{Gamepads, Button};


fn main()
{
    let mut game_controller_pc = ProcessConnector::new(64201);
    ...
    loop {
        ...
        let _check = game_controller_pc.send(64202, controller_data);
